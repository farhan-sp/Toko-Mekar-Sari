        ...
        >
            ...
            <nav class="flex-1 overflow-y-auto p-4 space-y-1">
                @php
                    ...
                    // Ubah ke huruf kecil semua biar aman (misal: 'Kasir' jadi 'kasir')
                ...
                @if($role !== 'kasir')
                    ...
                    <div class="pt-4 pb-2">
                        <p class="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Pembelian</p>
                    </div>
                    ...
                    <a href="{{ route('daftar.pembelian') }}" class="{{ activeClass('daftar.pembelian') }} group flex items-center px-3 py-2.5 text-sm font-medium border-l-4 rounded-r-md transition-colors">
                        <i class="fa-solid fa-file-invoice-dollar w-6 text-center mr-2 {{ request()->routeIs('daftar.pembelian') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-500' }}"></i>
                        Riwayat Pembelian
                    </a>
                @endif
                ...
                <div class="pt-4 pb-2">
                    <p class="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Penjualan</p>
                </div>
                ...
                <a href="{{ route('daftar.penjualan') }}" class="{{ activeClass('daftar.penjualan') }} group flex items-center px-3 py-2.5 text-sm font-medium border-l-4 rounded-r-md transition-colors">
                    <i class="fa-solid fa-file-invoice-dollar w-6 text-center mr-2 {{ request()->routeIs('daftar.penjualan') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-500' }}"></i>
                    Riwayat Penjualan
                </a>
