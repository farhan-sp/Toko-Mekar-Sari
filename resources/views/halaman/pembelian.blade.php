                        ...
                        <div class="bg-gray-50 p-4 rounded-xl border border-gray-100">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Kategori</label><div class="relative"><select name="id_kategori" class="px-2 w-full border border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500 py-2.5 appearance-none" required>@foreach ($kategori as $kat)<option value="{{ $kat['id_kategori'] }}">{{ $kat['nama_kategori'] }}</option>@endforeach</select><div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-gray-500"><i class="fa-solid fa-chevron-down text-xs"></i></div></div></div>
                                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Supplier</label><div class="relative"><select name="id_supplier" class="px-2 w-full border border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500 py-2.5 appearance-none" required>@foreach ($supplier as $sup)<option value="{{ $sup['id_supplier'] }}">{{ $sup['nama_supplier'] }}</option>@endforeach</select><div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-gray-500"><i class="fa-solid fa-chevron-down text-xs"></i></div></div></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-gray-50 p-4 rounded-xl border border-gray-100">
                                ...
                                <div class="space-y-4">
                                    <div class="grid grid-cols-2 gap-4">
                                        <div><label class="block text-sm font-semibold text-gray-700 mb-1">Awal</label><div class="relative rounded-md shadow-sm"><input type="number" name="jumlah_stok_barang" class="px-2 border border-gray-300 w-full rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500 py-2.5" placeholder="0" required></div></div>
                                        <div><label class="block text-sm font-semibold text-gray-700 mb-1">Min.</label><div class="relative rounded-md shadow-sm"><input type="number" name="stok_minimal" class="px-2 border border-gray-300 w-full rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500 py-2.5" placeholder="10" required></div></div>
                                    </div>
